...
static inline void rtl_is_sub_overflow(rtlreg_t* dest,//有问题
...
static inline void rtl_is_sub_carry(rtlreg_t* dest,//可能有问题
...
static inline void rtl_update_SF(const rtlreg_t* result, int width) {
  ...
  //t0 = result[width * 8 - 1];
  //t0 = (((*result & (0xffffffff >> ((4 - width) * 8))) & (1 << (width * 8 - 1))) != 0);
  rtl_set_SF(&t0);
}
